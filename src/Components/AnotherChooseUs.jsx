...
function AnotherChooseUs() {
    ...
    return (
        <div className="select-none bg-hotpink lg:pt-16 lg:pb-16  flex flex-col  justify-center">
            <ChooseUs />
            <div className='md:w-full  select-none lg:h-96 :flex justify-center'>
                <div className='bg-five lg:w-[1300px] md:w-[765px] md:flex justify-between   md:h-auto rounded-3xl'>
                    <div className='lg:p-16 p-12'>
                        ...
                        <div className=' text-white mt-4'>
                            ...
                            <div className='flex gap-4'>
                                ...
                                <div className='ml-12 md:ml-0 flex gap-4'>
                                    <AiOutlineArrowRight size={24} className='text-white' />
                            ...
                            <div className='flex gap-4'>
                                ...
                                <div className='mr-5 md:mr-0 flex gap-4'>
                                    <AiOutlineArrowRight size={24} className='text-white' />
