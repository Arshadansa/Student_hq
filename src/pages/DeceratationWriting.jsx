            ...
            <div className='flex select-none justify-center items-center p-10'>
                <div className='bg-lightblue w-[1600px] h-[290px] rounded-lg flex flex-col items-center pl-10 pr-10 pt-6 pb-6'>
                    ...
                    <div className="flex  justify-center items-center w-full h-full">
                        <ol class="flex items-center w-full text-sm font-medium text-center text-gray-500  shadow-sm shadow-slate-100 border-none border-gray-200 rounded-lg sm:text-base  sm:p-4 sm:space-x-4">
