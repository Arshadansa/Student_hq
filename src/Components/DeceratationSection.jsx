        ...
        <>
            <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    <p className="max-w-2xl mb-6  text-gray-500 lg:mb-8 md:text-lg lg:text-xl text-slate-900 font-normal ">   Get Online Dissertation Help From Our Experts Of Relevent Background</p>
                ...
                <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                    <img src="/image/diss.png" alt="hero image" />
                </div>
            ...
            <div className='w-full bg-white h-auto p-10 flex flex-col justify-center align-middle'>
                ...
                <div className='flex flex-col justify-start mt-3 mx-40'>
                    <ul class="list-decimal mx-5">
                        <li className='text-justify text-lg'><span className=' font-bold'>Choose your topic carefully:- </span> Your topic must be engaging and meaningful. Your dissertation is an opportunity to showcase your ideas and thoughts.</li>
                        <li className='text-justify  text-lg'><span className=' font-bold'> Have a clear goal & structure:-</span>
                        ...
                        <li className='text-justify  text-lg'><span className=' font-bold'>Write as you go-:</span>
