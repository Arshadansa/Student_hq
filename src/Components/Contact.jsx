          ...
          <div className="flex flex-col md:flex-row lg:flex-row md:flex-wrap lg:flex-wrap">
            ...
            <div className="p-2 w-full md:w-1/2 lg:w-1/2 md:ml-auto lg:ml-auto">
              <div className="flex flex-col text-black">
                ...
                <button onClick={handleFormSubmit} className="w-1/3 my-4 relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-white transition duration-300 ease-out border-2 rounded-full shadow-md group">
