...
export default function Faq() {
  return (
    <>
      <div className="flex m-3 select-none lg:p-20 md:p-0 flex-wrap lg:flex-nowrap justify-center align-middle  w-full h-full md:pt-8 md:pb-24  ">
        <div className="w-full  flex flex-col h-full">
          <div className="flex flex-col  h-full ">

            <div className="lg:text-4xl text-2xl md:text-5xl pl-3 p-10 md:tracking-normal  md:leading-tight font-semibold">
              <div className="text-primary mb-3 text-xl font-bold">
                <span>FAQ</span>
              </div>
              <h1 className="">Frequently asked question</h1>
              <p className="text-orange-500  text-xl">___</p>
              <span className="lg:text-3xl text-xl md:text-2xl">
                Still do you have any questions to know?
              </span>
              <h3 className="lg:text-3xl text-xl md:text-2xl font">
                Feel free to ask our experts here.
              </h3>
            </div>

            <div className="lg:mt-12 pl-3 md:text-left lg:text-left select-none ">
              <a
                href="#_"
                className="relative inline-flex  bg-white items-center justify-center overflow-hidden text-xs font-semibold py-4 px-8 lg:py-5 lg:px-12   font-sans tracking-tighter text-black border-[1px] border-gray rounded-2xl group"
              >
                ...
                <span className="relative  group-hover:text-white lg:text-xl text-lg ">
                  ASK YOUR QUESTIONS
                </span>
              </a>
            </div>
