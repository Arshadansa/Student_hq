...
const SuccessPopup = () => {
  ...
  return (
    ...
    <div
      className={`fixed inset-0 flex items-center justify-center z-10 bg-opacity-50 bg-gray-500 backdrop-filter backdrop-blur-sm transition-opacity ${isVisible ? 'opacity-100' : 'opacity-0 pointer-events-none'
        }`}
    >
  ...
  return (
    ...
    <div>
      ...
      <form ref={form} onSubmit={handleSubmit}>
        <div
          className="select-none mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto  text-gray-900 rounded-lg ">
